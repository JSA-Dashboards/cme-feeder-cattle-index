...
try:
    ...
    pass  # st.secrets not available (no secrets.toml locally) -- fine, .env already loaded above
...
<style>
  ...
  [data-testid="stSidebar"] {{
    background-color:#f6f8fa; border-right:1px solid {BORDER};
  }}
  .tile {{
...
st.markdown(
    f'<div style="font-family:inherit;color:#9aa2ab;font-size:inherit;line-height:1.6;text-align:center;padding:0 24px 24px;">'
